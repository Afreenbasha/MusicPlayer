...
public class MusicPlayerApp {
    ...
    public static void main(String[] args) {
        ...
        albums.get(1).addToPlayList("Rap God", playList_1);  // Corrected album index
        albums.get(1).addToPlayList("Lose Yourself", playList_1);  // Corrected album index

        play(playList_1);
    }

    private static void play(LinkedList<Song> playList) {
        Scanner sc = new Scanner(System.in);  // Corrected syntax
        boolean quit = false;
